...
Di tutorial ini, kami akan melakukan pemasangan Ubuntu desktop ke dalam komputer kamu, menggunakan drive DVD komputer ataupun menggunakan drive USB.
...
* Pastikan kamu memiliki cadangan data kamu baru-baru ini. Merkipun tidak mungkin
...
Tunggu beberapa saat, seletah destop termuat, kamu akan melihat jendela selamat datang. Dari sini kamu bisa memilih bahasa yang berada di list sebelah kiri dan memilih diantara menginstal Ubuntu secara langsung, atau mencoba desktop terlebih dahulu (Jika kamu menyukai apa yang kamu liat, kamu bisa memasang Ubunt dari mode ini juga).
...
Masukkan nama kamu dan pemasang akan automatis mensugestikan nama komputer dan username. Ini bisa berubah dengan mudah jika kamu lebih suka. Nama komputer adalah bagaimana komputer akan muncul di jaringan, Username kamu akan menjadi login kamu dan nama akun.
...
: Jika mengaktifkan folder rumah enskripsi dan kamu lupa password kamu, kamu tidak akan bisa mengambil data pribadi yang berada di folder rumah.
